      ...
      '--bounce-end-bg': getBounceOutColor(projectName),
          ...
          <div className=''>
            <div className="flex justify-between items-center">
                <h2 className='font-medium text-[14px] md:text-lg font-workSans text-card-heading tracking-wider'>WEBSITE</h2>
                {!available && <span className="rounded-card py-1 px-3 bg-card-coming-soon gap-2.5 font-workSans font-normal text-sm">Coming Soon</span>}
            </div>
            <div className="mb-8 space-y-4">
                <h3 className='font-normal text-2xl md:text-4xl tracking-wide text-white font-oggBook'>{projectName}</h3>
