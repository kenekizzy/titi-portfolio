...
const Hero = () => {
  return (
    <section className="flex flex-col md:flex-row md:justify-between items-center bg-portfolio pl-0  md:pl-32 pt-8">
        <div className='px-6 py-8 space-y-8'>
            ...
            <div className='flex flex-col space-y-2 md:space-y-0 md:flex-row md:justify-start pl-2 space-x-4'>
