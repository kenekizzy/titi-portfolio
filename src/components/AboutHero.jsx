        ...
        <section className='flex flex-col md:flex-row px-4 md:px-24 justify-between container-custom py-10'>
          ...
          <div className='flex-1 text-white'>
              ...
              <div className='flex flex-col space-y-6 md:space-y-0 md:flex-row md:justify-start space-x-0 md:space-x-4 py-10'>
                  <a href="/src/assets/images/titi-resume.docx"  download="Resume.pdf" className='flex justify-center items-center py-3 px-5 font-workSans bg-secondaryButton text-hero-secondaryButton border-none rounded-lg gap-2 w-full md:w-[250px]'>Download Resume <span><img src={DownloadIcon} alt="" /></span></a>
