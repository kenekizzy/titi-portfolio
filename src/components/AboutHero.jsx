...
const AboutHero = () => {
  return (
    <div className="bg-portfolio">
        <section className='flex flex-col md:flex-row px-4 md:px-0 justify-between container-custom pt-8'>
          ...
          <div className='flex-1 text-white'>
              ...
              <p className="text-xl font-normal font-nb leading-8 mb-7">Hey there! I'm Titi, a product designer with a passion for turning complex challenges into intuitive digital experiences. My journey took an exciting twist when I pivoted from Petroleum Engineering to the colorful world of UI/UX design – a move that perfectly blends my analytical mindset with my creative spirit.
