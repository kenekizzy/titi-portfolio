...
// import arrow from '../assets/icons/maki arrow.svg'
    ...
    return (
      <div className="bg-card-background border border-none my-8 rounded-md shadow-lg p-6 w-card-width h-card-height">
          ...
          <div className="mb-8 space-y-4">
              <h3 className='font-normal text-4xl text-white'>Sabiroad Admin</h3>
          ...
          <div>
              <img src={sabiroad} alt="" className='w-96 h-96'/>
          </div>
          {/* <img src={arrow} alt=""/> */}
      </div>
    )
