...
import Spectas from '../assets/images/Spcta.png'
...
const Specta = () => {
  return (
    <>
        ...
        <section className='container-custom my-8 px-4 md:px-0 text-white'>
            <h2 className='font-ogg font-bold text-5xl mb-6'>SPCTA</h2>
            ...
            <div className='overview my-4'>
                ...
                <p className='font-nb font-normal text-xl leading-9 my-2'>SPCTA is an app and website that seeks to eliminate waste in Nigeria. It helps to solve 
            ...
            <div className='role-view my-10 space-y-4'>
                ...
                <p className='leading-9 font-nb text-xl font-normal'>My role was to research and design the customer's interface both for the home owners and 
            ...
            <div className='tool-view my-10 space-y-4'>
                ...
                <p className='font-nb font-normal text-base'>3 months</p>
            </div>
            ...
            <h3 className='font-ogg font-bold text-2xl text-project-heading mt-2 mb-5'>Survey</h3>
            <p className='leading-9 font-normal text-xl font-nb my-2'>I  conducted user research using Surveys and Questionnaires to provide insight and help 
            ...
            <div className='p-8 bg-secondary-color flex flex-col md:flex-row justify-between rounded-lg'>
              ...
              <h2 className='text-project-primary font-bold text-2xl mb-4'>Key Insights from Survey</h2>
            ...
            <h3 className='font-ogg font-bold text-2xl text-project-heading mt-10 mb-6'>Competitive Analysis</h3>
            <p className='font-normal text-xl font-nb my-4 leading-8'>I conducted competitive analysis with key competitors in the waste management industry in Nigeria and globally highlighting their strengths and weaknesses. The objectives of this analysis was to aid in designing a user-friendly and intuitive app as well as  identifying features that resonate with users to ensure the app is a success.  Below is the analysis done: .</p>
            <div className='grid grid-cols-2 md:grid-cols-4 my-6 space-x-0 md:space-x-4 space-y-4 md:space-y-0 gap-x-4 md:gap-x-0'>
            ...
            <div className='p-8 bg-secondary-color flex flex-col-reverse md:flex-row justify-between rounded-lg'>
              <div className='flex-1'>
                <h3 className='text-project-primary font-bold text-2xl mb-4'>Key Insights from Competitive Analysis</h3>
                <ul className='list-disc list-inside ml-3 leading-9 font-normal text-xl font-nb text-project-primary-fade space-y-2'>
            ...
            <div className='my-10 space-y-4'>
              ...
              <p className='leading-9 font-normal text-xl font-nb'>In Nigeria, inadequate waste management infrastructure and lack of reliable services lead to 
              ...
              <p className='leading-9 font-normal text-xl font-nb'>Based on the insights gathered, i created two personas that represent our ideal users.</p>
            </div>
            ...
            <div className='flex flex-col md:flex-row justify-between space-y-4 md:space-y-0 gap-x-12 my-6'>
              <div className="bg-white rounded-lg overflow-hidden flex-1 text-user-color py-4">
                  <div className="flex items-center p-4">
                    ...
                    <div>
                      <h2 className="text-2xl font-normal">Ojukwu Kunle</h2>
                  ...
                  <div className="px-4">
                    <div className="mb-4">
                      ...
                      <p className="text-base font-normal leading-6">Chinedu is a 42-year-old small business owner from Enugu, running an electronics shop. 
              ...
              <div className="bg-white rounded-lg overflow-hidden flex-1 text-user-color py-4">
                  <div className="flex items-center p-4">
                    ...
                    <div>
                      <h2 className="text-2xl font-normal">Adaeze Danjuma</h2>
                  ...
                  <div className="px-4">
                    <div className="mb-4">
                      <h3 className="text-lg font-semibold">About</h3>
                      <p className="text-base font-normal leading-6">Adaeze is a 30-year-old secondary school teacher living in Lagos. 
            ...
            <p className='font-normal text-xl font-nb mt-2 mb-10'>Based on the requirements provided and research conducted I  created a site map to organize 
              the 
            ...
            <p className='font-normal text-xl font-nb mb-4'>To further define users’ actions, we created user flow for a waste generator to gain a better 
            ...
            <p className='font-normal text-xl font-nb mb-10'>I created  wireframes based on sketches done, to act as the foundation for a mobile app's design, 
            ...
            <p className='font-normal text-xl font-nb mb-4'>After creating the wireframes, I moved on to create the high-fidelity designs on Figma as well as 
